...
if (language_code === 'fr') {
    ...
    text_tutorial_1_0 = "Au milieu de l'écran, un objet sera affiché rapidement.";
    text_tutorial_1_1 = "Cet objet sera un véhicule de type camion (gauche) ou voiture (droite).";

    text_tutorial_2_0 = "Positionnez vos doigts sur les touches C et V du clavier.";
    text_tutorial_2_1 = "Si le camion apparaît, cliquez sur la touche C.";
    text_tutorial_2_2 = "Si la voiture apparaît, cliquez sur la touche V.";
    ...
    text_tutorial_5_0 = "Dans la tâche réelle, l'étoile et le véhicule apparaîssent en même temps.";
    ...
    text_tutorial_1_0 = "In the center of the screen, a vehicle will be quickly shown.";
    text_tutorial_1_1 = "It will either be a truck (left) or a car (right).";

    text_tutorial_2_0 = "Position your fingers on the key C and V of your keyboard.";
    text_tutorial_2_1 = "If the truck appears click on C.";
    text_tutorial_2_2 = "If the car appears click on V.";
    ...
    text_tutorial_5_0 = "In the real task, both the vehicle and the star will be shown simultaneously.";
